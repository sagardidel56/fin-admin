...
import UserPage from '../pages/presentation/User/UserPage';
import CompetitionPage from '../pages/presentation/Competition/CompetitionPage';
...
const presentation: RouteProps[] = [
	...
	{
		path: dashboardPagesMenu.home.path,
		element: <UserPage />,
	},
	{
		path: dashboardPagesMenu.Competition.path,
